				...
				<table class="table_liste_records table">
                    ...
                    <tbody>
						...
						<tr>
							...
							<td>
                              <a href="<?php echo site_url('tax/edit_tax/'.$row->tax_id.'/'.encode_id($row->tax_id)); ?>" class="list_link_edit" title="Edit" data-id="<?php echo $row->tax_id;?>" data-code="<?php echo encode_id($row->tax_id);?>"><i class="fa fa-pencil"></i></a>
                              <a href="#" class="list_link_delete" data-id="<?php echo $row->tax_id;?>" data-code="<?php echo encode_id($row->tax_id);?>" title="Delete"><i class="fa fa-trash"></i></a>
                          	</td>
                        </tr>
                        <?php endforeach; ?>
						<?php else : ?>
