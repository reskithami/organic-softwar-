						...
						echo form_open('order/add_order', $attributes);?>
							<fieldset>
							   	...
							   	<div class="form_item <?php echo $error; ?>">
							        ...
							        <div class="controls">
									    <select name="order_status_array_id" id="order_status_array_id" class="input-xlarge chosen">
							                ...
							                <?php if(isset($order_status_array_records)) : foreach($order_status_array_records as $row) : ?>
											<option value="<?php echo $row->order_status_array_id; ?>" <?php echo set_select('order_status_array_id', $row->order_status_array_id); ?>  >
											<?php echo $row->order_name; ?></option>
											<?php endforeach; ?>
											<?php endif; ?>
							            </select>
								...
								<?php $error = ''; if(form_error('affiliate_id')){ $error = 'error'; } ?>
							   	...
							   	<div class="form_item <?php echo $error; ?>">
									<?php $attributes = array('class' => 'control-label');
									echo form_label($this->lang->line('affiliate'), 'affiliate_id', $attributes);?>
							        <div class="controls">
									    <select name="affiliate_id" id="affiliate_id" class="input-xlarge chosen">
							                ...
							                <?php if(isset($affiliate_records)) : foreach($affiliate_records as $row) : ?>
											<option value="<?php echo $row->affiliate_id; ?>" <?php echo set_select('affiliate_id', $row->affiliate_id); ?>  >
											<?php echo $row->affiliate_name; ?></option>
											<?php endforeach; ?>
											<?php endif; ?>
							            </select>
										<?php echo form_error('affiliate_id', '<span class="alert-warning">', '</span>'); ?>
									</div>
							  	</div>
								...
								<?php $error = ''; if(form_error('currency_id')){ $error = 'error'; } ?>
							   	...
							   	<div class="form_item <?php echo $error; ?>">
									<?php $attributes = array('class' => 'control-label');
									echo form_label($this->lang->line('currency'), 'currency_id', $attributes);?>
							        <div class="controls">
									    <select name="currency_id" id="currency_id" class="input-xlarge chosen">
							                ...
							                <?php if(isset($currency_records)) : foreach($currency_records as $row) : ?>
											<option value="<?php echo $row->currency_id; ?>" <?php echo set_select('currency_id', $row->currency_id); ?>  >
											<?php echo $row->currency_name; ?></option>
											<?php endforeach; ?>
											<?php endif; ?>
							            </select>
										<?php echo form_error('currency_id', '<span class="alert-warning">', '</span>'); ?>
									</div>
							  	</div>
