	...
	<form class="form-vertical" method="post" action="<?php echo site_url('generator2/generate_it'); ?>" enctype="multipart/form-data" >
    <fieldset>
    ...
    <div class="control-group">
        ...
        <div class="span2">
            ...
            <div class="controls">
			  ...
			  <label class="radio">
                <input type="radio" value="hidden" name="<?php echo $input_type_name; ?>" <?php if($input_type_checked =='hidden'){ ?> checked="checked" <?php } ?> >
                Hidden
              </label>
              <label class="radio">
