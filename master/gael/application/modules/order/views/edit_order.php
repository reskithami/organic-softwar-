									    ...
									    <select name="customer_id" id="customer_id" class="input-xlarge chosen">
							                ...
							                <?php if(isset($customer_records)) : foreach($customer_records as $key => $val) :
							                	...
							                	if ( $this->input->post("customer_id") )  {
													if( $this->input->post("customer_id") == $val->id){ $selected = "selected"; }
												}else{
													if($order_records->customer_id == $val->id ) { $selected = "selected"; }
												}
							                ?>
											<option value="<?php echo $val->id; ?>" <?php echo $selected; ?>  >
											<?php echo $val->first_name; ?></option>
											<?php endforeach; ?>
											<?php endif; ?>
							            </select>
									    ...
									    <select name="saller_id" id="saller_id" class="input-xlarge chosen">
							                ...
							                <?php if(isset($saller_records)) : foreach($saller_records as $key => $val) :
							                	...
							                	if ( $this->input->post("saller_id") )  {
													if( $this->input->post("saller_id") == $val->id){ $selected = "selected"; }
												}else{
													if($order_records->saller_id == $val->id ) { $selected = "selected"; }
												}
							                ?>
											<option value="<?php echo $val->id; ?>" <?php echo $selected; ?>  >
											<?php echo $val->first_name; ?></option>
