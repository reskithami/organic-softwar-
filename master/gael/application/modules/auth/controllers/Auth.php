...
class Auth extends CI_Controller {
	...
	function _render_page($view, $data=null, $render=true)
	{
		...
		$data['content'] = $this->load->view($view, $this->viewdata, $render);
                
                $data['logedUser'] = $this->ion_auth->user()->row();
                $data['header'] = '';
                $data['titelHeader'] = $this->lang->line('users');
