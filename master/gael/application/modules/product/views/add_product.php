							...
							<fieldset>
							   	...
							   	<div class="form_item <?php echo $error; ?>">
							        ...
							        <div class="controls">
									    <select name="type" id="type" class="input-xlarge chosen">
											...
											<option value="<?php echo $row->type; ?>" <?php echo set_select('type', $row->type); ?>  >
							   	...
							   	<div class="form_item <?php echo $error; ?>">
							        ...
							        <div class="controls">
										<div class="input-append date form_date" data-date-format="dd-mm-yyyy">
											<input class="form-control" type="text" name="date_available" id="date_available" value="<?php echo set_value('date_available'); ?>" /><span class="add-on"><i class="icon-calendar"></i></span>
										</div>
								...
								<?php $error = ''; if(form_error('date_added')){ $error = 'error'; } ?>
							   	...
							   	<div class="form_item <?php echo $error; ?>">
							        ...
							        <div class="controls">
										<div class="input-append date form_date" data-date-format="dd-mm-yyyy">
											<input class="form-control" type="text" name="date_added" id="date_added" value="<?php echo set_value('date_added'); ?>" /><span class="add-on"><i class="icon-calendar"></i></span>
										</div>
							   	...
							   	<div class="form_item <?php echo $error; ?>">
							        ...
							        <div class="controls">
									    <select name="manufacturer_id" id="manufacturer_id" class="input-xlarge chosen">
							                ...
							                <?php if(isset($manufacturer_records)) : foreach($manufacturer_records->result() as $row) : 
                                                                            ?>
