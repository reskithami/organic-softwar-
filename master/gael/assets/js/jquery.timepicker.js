...
(function($) {
	...
	var Timeselector = function() {
		...
		var presentDate = new Date();
                ...
                var rondMinutes = Math.round(presentDate.getMinutes()/10)*10;
                presentDate = new Date(0,0,0, presentHours, rondMinutes);
		this.uuid = presentDate.getTime();
	...
	Timeselector.prototype = {
		...
		_setTimeFromField: function(inst) {
			...
			var presentDate = new Date();
                        var presentHours = presentDate.getHours();
                        var rondMinutes = Math.round(presentDate.getMinutes()/10)*10;
			var date = new Date(0,0,0, presentHours, rondMinutes),
				matches, hour;
		...
		_hide: function() {
			...
			this._showing = false;
                        inst.options.callbackHide(inst.input,inst.date);
		},
